...
variables. 
After cleaning, and getting dropping non available observations, we managed to 
reduce to 468 observations with 32 variables.
Finally, we tidied using a pivot_longer to finally obtain a data set of 1065 
observations over 9 variables
...
-   The mode is the consumption of alcohol with a proportion of 55 % followed by
hepatitis C at 33.2%. Both are likely major factors at causing liver cirrhosis.
