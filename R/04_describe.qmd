...
We have 3 main data sets: the original one, the cleaned one with amongst other things the removal of NA and the tidy data sets.
...
The original data set consisted in 733 cirrhosis' hospitalized patients with 91 variables. After cleaning, and getting dropping non available observations, we managed to reduce to 468 observations with 32 variables. Finally, we tidied using a pivot_longer to finally obtain a data set of 1065 observations over 9 variables
...
To better illustrate that both have their mode (most commonly occurring number in the data set) at \[60;70\], the plot is also shown faceted.
...
Ascites and hepatic encephalopathy are the two main liver diseases diagnosed. Ascites, representing 31% of liver diseases, is a build up of fluid in the abdomen, often as a consequence of cirrhosis. Hepatic encephalopathy is also a common pathology in patients with cirrhosis due to deficiencies in their neurological system, here representing 21.2% of the study.
