...
In the first file of the analysis, we try to determine how the patients' mortality can be affected by some variables, for example the age, the type of liver disease or the type of etiology.
...
In that file, we study the effect of the different etiologies and comorbidities on the Child Pugh Score.
