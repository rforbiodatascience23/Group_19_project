...
::: {.column width="40%"}
![](../results/plots/Age_gender2.png){width="100%"} ![](../results/plots/Overview_LD.png){width="100%"}
:::
:::
...
::: columns
::: {.column width="33%"}
![](../results/plots/boxplot_logistic_confidence_interval){width="100%"}
:::

::: {.column width="33%"}
![](../results/plots/mortality_CPS){width="100%"}
:::
